...
from transformer.models.decoder.myGPT import MyGPTLM
from transformer.schedulers import CosineWarmupScheduler


class MyGPTLightning(pl.LightningModule):
    def __init__(
        self,
        decoder_params: Dict,
        ...
        self.decoder = MyGPTLM(**decoder_params)
    ...
    def training_step(self, batch, batch_idx):
        ...
        out = self.decoder(x, non_pad_indexes)
    ...
    def generate_text(self, **kwargs):
        return self.decoder.generate_text(**kwargs)
